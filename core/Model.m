classdef Model
    ...
    methods
        ...
        function obj=Model(config)
            ...
            %Input of additional excitability
            stencilExcitability=zeros(obj.W,1);
            if config.Excitabilityconnections==1
                stencilExcitability(1:obj.L,1)=1;
            elseif config.Excitabilityconnections==2
                stencilExcitability(1:2*obj.L,1)=1;
            end

            obj.stencilExcitability=stencilExcitability;
